...
//   const BoxShadow(color: Color(0xff393739ff), blurRadius: 30, offset: Offset(0, 10))
// ];
//
// List<Map> categories = [
//   {'name': 'Home', 'iconPath': 'images/logo-home.png'},
//   {'name': 'Upload', 'iconPath': 'images/Upload.png'},
//   {'name': 'Favorites', 'iconPath': 'images/heart.png'},
//
// ];
//
// List<Map> drawerItems=[
//   // {
//   //   'icon': "images/back_logo1.png",
//   //   'title':'logo'
//   // },
//   {
...
// import 'package:flutter/material.dart';
// import 'package:blog2/authentication_page.dart';
// import 'package:blog2/blogs.dart';
// import 'package:font_awesome_flutter/font_awesome_flutter.dart';
...
//
//   SingleItem({Key key, this.image, this.title, this.description})
//       : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
